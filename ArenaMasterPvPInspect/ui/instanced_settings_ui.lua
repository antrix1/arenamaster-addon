AMPVP_CreateFrame2("AMPVP_SettingsUI_Instanced", UIParent, "CENTER", 0, 0, 420, 580, 0.6, true)
...
AMPVP_CreateText("catSpecBrackets", AMPVP_SettingsUI_Instanced, "TOPLEFT", 25, -450, "Per-Spec Brackets:")
AMPVP_CreateCheckbox("INST_SOLO_SHUFFLE", AMPVP_SettingsUI_Instanced, "TOPLEFT", 25, -465, "Display Solo Shuffle")
AMPVP_CreateCheckbox("INST_BLITZ", AMPVP_SettingsUI_Instanced, "TOPLEFT", 25, -490, "Display Blitz")
